...
function AnonionPage({ isOwner, anonion, responses, displayName }) {
	...
	useEffect(() => {
		if (AuthUser.firebaseUser != null) {
			setMessage(AuthUser.firebaseUser.displayName + " wants your anonionous opinion in something")
		}
	}, [AuthUser])
		...
		<main className="w-11/12 m-auto max-w-screen-md">
			...
			<div style={{ boxShadow: "0 2px 13px -2px rgb(0 0 0 / 10%)" }} className="bg-white w-full rounded-lg p-4 text-center">
				...
				<div className="flex flex-row justify-center m-3">
					<a href={"https://twitter.com/intent/tweet?text=" + message + "&url=" + shareURL}></a>
